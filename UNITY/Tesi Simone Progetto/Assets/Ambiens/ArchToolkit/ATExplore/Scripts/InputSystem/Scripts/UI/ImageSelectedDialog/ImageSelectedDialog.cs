...
namespace ArchToolkit.InputSystem
{
    ...
    public class ImageSelectedDialog : SingletonPrefab<ImageSelectedDialog>
    {
        ...
        /*TODELETE
        public Text title; ENNIO
        public Text description; ENNIO
        private Vector3 planeNormal = Vector3.up;
        private bool followVRPad = false;
        [SerializeField]
        ...
        public void InitMenu(int currSelectIndex, List<Variant> elementsLogics, Action<Variant> onClick, Action onClose, Transform positionAndRotation)
        {
            ...
            {
                //this.title.text = itemsSelected[0].name; ENNIO
            ...
            */
            ...
            /* TODELETE
            if (ArchToolkitManager.Instance.movementTypePerPlatform == MovementTypePerPlatform.VR || ArchToolkitManager.Instance.movementTypePerPlatform == MovementTypePerPlatform.VR_Mobile)
            {
            ...
            if (!this.followVRPad && ArchToolkitManager.Instance.movementTypePerPlatform == MovementTypePerPlatform.VR_Mobile)
            {
                this.radius = 0.5f;
                this.heightOfInterface = -0.45f;
            }*/
